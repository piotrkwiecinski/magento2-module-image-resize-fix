...
namespace PiotrKwiecinski\ImageResizeFix\Block\Product;

use Magento\Catalog\Model\View\Asset\ImageFactory as AssetImageFactory;
use Magento\Framework\View\ConfigInterface;
use PiotrKwiecinski\ImageResizeFix\Model\Product\Image\ParamsBuilder;
...
class ImageBlockBuilder
{
    ...
    public function buildBlock($product, $displayArea)
    {
        ...
        $template = $template = $image['keep_frame'] == 'frame'
